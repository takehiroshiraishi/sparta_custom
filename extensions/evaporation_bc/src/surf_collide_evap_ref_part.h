...
SurfCollideStyle(evaprefpart,SurfCollideEvapRefPart)

#else

#ifndef SPARTA_SURF_COLLIDE_EVAP_REF_PART_H
#define SPARTA_SURF_COLLIDE_EVAP_REF_PART_H
...
class SurfCollideEvapRefPart : public SurfCollide {
 public:
  SurfCollideEvapRefPart(class SPARTA *, int, char **);
  SurfCollideEvapRefPart(class SPARTA *sparta) : SurfCollide(sparta) {} // needed Kokkos
  virtual ~SurfCollideEvapRefPart();
  virtual void init();
