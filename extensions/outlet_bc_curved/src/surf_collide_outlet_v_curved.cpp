...
#include "math.h"
#include "surf_collide_outlet_v_curved.h"
#include "surf.h"
...
SurfCollideOutletVCurved::SurfCollideOutletVCurved(SPARTA *sparta,
                                                   int narg, char **arg) :
  SurfCollide(sparta, narg, arg)
{
  if (narg != 5) error->all(FLERR,"Illegal surf_collide outletv/curved command");
...
SurfCollideOutletVCurved::~SurfCollideOutletVCurved()
{
  if (copy) return;
